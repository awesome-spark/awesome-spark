...
* [Spark in Motion](https://www.manning.com/livevideo/spark-in-motion) - teaches you to use Spark for big data analytics through video-based lessons and built-in exercises.
